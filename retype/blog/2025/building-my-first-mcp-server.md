...
tags: [MCP, Claude, Obsidian, Python, AI Tools]
date: 2025-08-02
---
...
The core insight was making it **conversational**—instead of automatic hooks, you explicitly ask Claude to save content:
...
The installer:
- ✅ Checks Python 3.8+ and installs MCP dependencies
- ✅ Prompts for your Obsidian vault path
- ✅ Installs the MCP server globally to `~/.claude/`
- ✅ Configures Claude Code settings automatically
- ✅ Optionally creates project-specific configuration
